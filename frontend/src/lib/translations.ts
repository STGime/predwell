...
export const translations = {
  ...
  'feat.wg': { en: 'Include WG rooms', de: 'WG-Zimmer einschließen' },
  'feat.no_wg': { en: 'No WG flats', de: 'Keine WG-Wohnungen' },
  ...
  'src.wg_gesucht': { en: 'WG-Gesucht', de: 'WG-Gesucht' },
  'src.inberlinwohnen': { en: 'Public housing', de: 'Landeseigene' },
  'src.openimmo': { en: 'Direct from agent', de: 'Direkt vom Anbieter' },
  'src.seed': { en: 'Sample', de: 'Beispiel' },
